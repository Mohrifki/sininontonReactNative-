...
import MoviesSreen from '../ui/screens/main/Home/MovieScreen';
import TvShowScreen from '../ui/screens/main/Home/TvShowScreen';
import FavouritesSreen from '../ui/screens/main/Home/FovouritesScreen';
import AccountSreen from '../ui/screens/main/Home/AccountScreen';
...
const HomeBottomTab = () => {
  return (
    <Tab.Navigator tabBar={(props) => <MyTabBar {...props} />} >
      <Tab.Screen name="Movies" component={MoviesSreen} />
      <Tab.Screen name="TvShow" component={TvShowScreen} />
      <Tab.Screen name="Fovourites" component={FavouritesSreen} />
      <Tab.Screen name="Account" component={AccountSreen} />
    </Tab.Navigator>
  );
};
